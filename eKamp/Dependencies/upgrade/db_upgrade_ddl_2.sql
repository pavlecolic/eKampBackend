...
-- Table `eKamp`.`message`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eKamp`.`message` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `content` VARCHAR(1000) NULL,
  `time_created` DATETIME NOT NULL,
  `employee_person_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_message_employee1_idx` (`employee_person_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `eKamp`.`user_messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eKamp`.`user_messages` (
  `message_id` INT NOT NULL,
  `employee_person_id` INT NOT NULL,
  `read_at` TIMESTAMP NULL,
  PRIMARY KEY (`message_id`, `employee_person_id`),
  INDEX `fk_message_has_employee_employee1_idx` (`employee_person_id` ASC) VISIBLE,
  INDEX `fk_message_has_employee_message1_idx` (`message_id` ASC) VISIBLE,
  CONSTRAINT `fk_message_has_employee_message1`
    FOREIGN KEY (`message_id`)
    REFERENCES `eKamp`.`message` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_message_has_employee_employee1`
    FOREIGN KEY (`employee_person_id`)
    REFERENCES `eKamp`.`employee` (`person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
